package com.mertakdogan.rickandmortytimer_java;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.dubdub);
        imageViewCrazy = findViewById(R.id.imageViewCrazy);
